...
2. Install LocalDb. If you use Visual Studio: via the installer, modify the installation to include "SQL Server Express 2025 LocalDB". Otherwise, [install it with the SQL Server installer](https://learn.microsoft.com/en-us/sql/database-engine/configure-windows/sql-server-express-localdb?view=sql-server-ver16).
